...
var c1=0;
var footer="<br><center><hr size='1' width='400px'><small>* This page was generated by 'Solar Calculator'<br>";
footer=footer+"Source repository: <a href='https://github.com/asheshwor/solar-calculator'>https://github.com/asheshwor/solar-calculator</a>.<br>";
...
html=" ";
html=html+"<HTML><HEAD><META NAME='GENERATOR' Content='Solar Calculator 4.0'><TITLE>Solar Calculator Data Table [for "+getMonthName()+"]</TITLE>";
html=html+"<SCRIPT "+"LANGUAGE=javascript"+">function finish()";
html=html+"{window.status=' * Solar Calculator [HTML report for "+getMonthName()+"] *'}</"+"SCRIPT>";
